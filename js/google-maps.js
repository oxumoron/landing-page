...
// Basic options for a simple Google Map
    ...
    if (mapElement) {
        ...
        let myLatlng = new google.maps.LatLng(49.0347165,38.3634737);

        // Add your company name and some text about company
        let maptooltipbold = 'Артем Супрун';
        ...
        content.innerHTML = "<div class="+"map-tooltip"+"><h4><strong>"+maptooltipbold+"</strong></h4><hr>"+"</div>";
